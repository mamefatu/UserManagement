	    	...
	    	<div class="col-md-10 col-md-offset-2">
	    		<div class="panel panel-default">
				  	<div class="panel-heading">
				    	<h3 class="panel-title">Edit User : <span class="${empty form.erreurs ? 'text-success' : 'text-danger'} text-center">${form.resultat}</span></h3>
				 	</div>
				  	...
				  	<div class="panel-body text-warning">
	                    ...
	                    <fieldset>
				    		...
				    		<input class="btn btn-warning btn-block" type="submit" value="Modifier">
				    	</fieldset>
				      	</form>
				      	<br/>
